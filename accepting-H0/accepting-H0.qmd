...
nocite: |
  @Hyde2005
citation:
  url: https://agrogan1.github.io/Bayes/accepting-H0/accepting-H0.html
---
...
::: {.callout-tip}
## Accepting The Null Hypothesis May Have Scientific Value

Accepting $H_0$ may be very scientifically valuable, and may have consequences for affirming similarity, universality, or treatment invariance [@Gallistel2009; @Morey2018]. See, for examples, @sec-substantive-cases.
...
![Thomas Bayes](Thomas_Bayes.png){width=10% fig-align="left" #fig-Bayes}
...
# Important Substantive Cases {#sec-substantive-cases}
...
description <- c("Equivalence Of 2 Treatments Or Interventions",
                 "Equivalence Of 2 Or More Groups On An Outcome",
